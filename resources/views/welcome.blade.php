    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                    ...
                    <a href="https://laracasts.com"
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                ...
                                development @php echo $collage  @endphp. Check them out, see for yourself, and massively level up
                ...
                <div>
                    <h3>Code:</h3>
                    {{-- <h4><a href="{{route('user.details')}}">New Route</a></h4> --}}
                    <h4><a href="/user">New Route</a></h4>
                </div>
            </div>
